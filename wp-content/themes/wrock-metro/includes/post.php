...
<?php if ( has_post_thumbnail() ) {
the_post_thumbnail();
} ?></div><div class="entry"><?php wrockmetro_excerpt('wrockmetro_excerptlength_index', 'wrockmetro_excerptmore'); ?>
		</div><a href="<?php the_permalink(); ?>"><span class="readmore">Read More..</span></a></article>
