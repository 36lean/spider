...
/* ----------------------------------------------------------------------------------- */
    ...
    function wrockmetro_of_head_css() {
        $output = '';
        $custom_css = wrockmetro_get_option('wrockmetro_customcss');
        if ($custom_css <> '') {
            $output .= $custom_css . "\n";
        }
// Output styles
...
/////////Theme Options
    ...
    function wrockmetro_childtheme_favicon() {
        if (wrockmetro_get_option('wrockmetro_favicon') != '') {
            echo '<link rel="shortcut icon" href="' . wrockmetro_get_option('wrockmetro_favicon') . '"/>' . "\n";
        } 
    }
